...
// node_modules/bigint-polyfill/index.js
var require_bigint_polyfill = __commonJS({
  "node_modules/bigint-polyfill/index.js"(exports, module) {
    ...
    var _BigInt = require_BigInteger();
    var nativeFunction = function(operator, a) {
      switch (operator) {
        case "add":
          return (b) => new BigInt2(a + b);
        case "subtract":
          return (b) => new BigInt2(a - b);
        case "multiply":
          return (b) => new BigInt2(a * b);
    ...
    var BigInt2 = class {
      constructor(value) {
        if (typeof value === "bigint") {
          this.value = value;
        } else if (value instanceof BigInt2) {
          return value;
        } else {
        ...
        return new Proxy(this, {
          get(obj, field) {
            ...
            if (typeof obj.value === "bigint")
              return nativeFunction(field, obj.value);
      ...
      _toUint8Array(littleEndian = false, elements = 8) {
        ...
        if (littleEndian)
          uint8arr.set(intarr.reverse(), 0);
        else
          uint8arr.set(intarr, elements - intarr.length);
        return uint8arr;
      }
      ...
      static fromUint8Array(uint8arr, littleEndian = false, detectSupport = true) {
        if (supportsNative && detectSupport) {
          ...
          return new BigInt2(view.getBigUint64(0, littleEndian));
        }
        let array;
        if (littleEndian) {
        ...
        return new BigInt2(_BigInt.fromArray(array, 2 ** 8));
      }
    };
    module.exports = BigInt2;
  }
});
export default require_bigint_polyfill();
